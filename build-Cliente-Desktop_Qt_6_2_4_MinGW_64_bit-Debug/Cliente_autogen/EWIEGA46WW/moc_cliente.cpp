...
#define QT_MOC_LITERAL(ofs, len) \
    uint(offsetof(qt_meta_stringdata_cliente_t, stringdata0) + ofs), len 
static const qt_meta_stringdata_cliente_t qt_meta_stringdata_cliente = {
    {
QT_MOC_LITERAL(0, 7) // "cliente"
...
const QMetaObject cliente::staticMetaObject = { {
    ...
    qt_meta_stringdata_cliente.offsetsAndSize,
    qt_meta_data_cliente,
    qt_static_metacall,
    nullptr,
qt_incomplete_metaTypeArray<qt_meta_stringdata_cliente_t
, QtPrivate::TypeAndForceComplete<cliente, std::true_type>
